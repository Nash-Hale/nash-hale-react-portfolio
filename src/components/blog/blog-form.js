...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://nashhale.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  UNSAFE_componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://nashhale.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
    ...
    return (
      <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
        <div className="two-column">
          ...
          {/* TODO
            MAKE A DROPDOWN FOR THE BLOG-FORM  
          */}
          {/* <select
            type="text"
            onChange={this.handleChange}
